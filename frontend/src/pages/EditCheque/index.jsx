...
import { getSingleCheque,updateCheques } from '../../services/cheque';
import 'react-datepicker/dist/react-datepicker.css';

class EditCheques extends Component {
  state = {
    accNo: '',
    chequeBooks: 1,
    chequeOption : '',
  ...
  fetchCheques = async () => {
    try {
      ...
      const response = await getSingleCheque(this.props.match.params.id);

     this.setState({
          accNo: response.data.accNo,
          chequeBooks: response.data.chequeBooks,
          chequeOption: response.data.chequeOption,
  ...
  onSubmit = async (e) => {
    ...
    try{
      const response = await updateCheques(this.props.match.params.id,cheque);
      ...
      <div style={{ width: '40rem' , marginLeft: '250px' , marginRight: '250px' }} >
        ...
        <form onSubmit={this.onSubmit}>
          <div className="form-group" style={{ fontWeight: "bold" }}> 
            ...
            >
              <option value="Current - 123456789012">Current - 123456789012</option>
              <option value="Current - 210987654321">Current - 210987654321</option>
            </select>
          </div>
          <div className="form-group" style={{ fontWeight: "bold" }}>
